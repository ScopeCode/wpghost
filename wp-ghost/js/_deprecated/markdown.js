$(document).ready(function () {
    ...
    function H(e, t) {
        ...
        if (!e.options.lineWrapping) {
            var k = i.lastChild;
            3 == k.nodeType && (k = i.appendChild(Ur("span", "â€‹"))), p.width = qr(k).right - f.left
        }
        return p
    }
            ...
            if (qi.test(t))
                for (var o = document.createDocumentFragment(), a = 0;;) {
                    ...
                    if (a += s + 1, "	" == l[0]) {
                        ...
                        var h = Ur("span", "â€¢", "cm-invalidchar");
    ...
    function Xn(e, t, n, r, i) {
        for (var o = 0; o < t.length; ++o) {
            var a = t.charAt(o),
                l = 0 == o;
            a >= "í €" && "í¯¿" > a && o < t.length - 1 ? (a = t.slice(o, o + 2), ++o) : o && e.cm.options.lineWrapping && so.test(t.slice(o - 1, o + 1)) && e.pre.appendChild(Ur("wbr")), e.measure[e.pos] = jn(e, a, n, l && r, o == t.length - 1 && i), e.pos += a.length
        }
    ...
    function Qr(e) {
        ...
        return uo ? Ur("span", "â€‹") : Ur("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px")
    }
